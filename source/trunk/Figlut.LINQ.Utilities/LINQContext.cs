namespace Figlut.LINQ.Utilities
{
    ...
    public class LINQContext
    {
        ...
        public LINQContext(DataContext db, bool applyContextSettings)
        {
            DB = db;
            if (applyContextSettings)
            {
                _db.Connection.ConnectionString = LINQOptions.Instance.Settings.ConnectionString;
                _db.CommandTimeout = LINQOptions.Instance.Settings.LinqToSQLCommandTimeout;
        ...
        public virtual List<ChangeResult> Save<E>(E entity, bool saveChildren, bool submitChanges) where E : class
        {
        ...
        public virtual List<ChangeResult> Save<E>(E entity, bool saveChildren) where E : class
        {
            return Save<E>(entity, saveChildren, true);
        }
        ...
        private List<ChangeResult> UpdateOriginalEntity<E>(E original, E latest, bool saveChildren)
        {
        ...
        public virtual List<ChangeResult> Delete<E>(E entity) where E : class
        {
        ...
        /// <returns>Returns a list of change results.</returns>
        public virtual List<ChangeResult> Delete<E, T>(E entity, bool createTombstone)
            where E : class
            where T : class
        {
            PropertyInfo surrogateKey = GetEntitySurrogateKey<E>();
        ...
        public virtual List<ChangeResult> DeleteAll<E>() where E : class
        {
            Table<E> table = DB.GetTable<E>();
